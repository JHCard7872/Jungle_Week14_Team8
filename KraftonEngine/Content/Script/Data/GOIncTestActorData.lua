...
return {
    ...
    ID_CARD_TAG = "IDCard",
    ID_CARD_HIT_RIM_DURATION = 2.00,
    ID_CARD_HIT_RIM_FLASH_INTENSITY = 3.8,
    ID_CARD_HIT_RIM_SUSTAIN_INTENSITY = 1.35,
    ID_CARD_HIT_RIM_POWER = 2.8,
    ID_CARD_HIT_RIM_STYLE = 0.0,
    ID_CARD_HIT_UV_NOISE_DENSITY = 28.0,
    ID_CARD_HIT_UV_SCROLL_SPEED = 5.50,
    ID_CARD_HIT_RIM_COLOR_R = 1.00,
    ID_CARD_HIT_RIM_COLOR_G = 0.95,
    ID_CARD_HIT_RIM_COLOR_B = 0.08,
    ID_CARD_HIT_RIM_COLOR_A = 1.00,
    ID_CARD_HIT_IMPACT_INTENSITY = 1.8,
    ID_CARD_REMOVE_DELAY = 1.00,
    ID_CARD_SHRINK_DURATION = 0.70,
    ID_CARD_SHRINK_MIN_SCALE = 0.02,
    ID_CARD_POPUP_SFX_KEY = "sfx_popup_info_0",
    ID_CARD_POPUP_SFX_VOLUME_SCALE = 1.00,
